# Diff Reference for Batch 25

```diff
diff --git a/nce/consolidation.py b/nce/consolidation.py
index a97b9e9..228bbcd 100644
...
+    ),
     Tool(
         ...
         description=(
@@ -1486,4 +1573,34 @@ if cfg.NCE_D365_ENABLED:
...
@@ -144,6 +145,10 @@ TOOL_REGISTRY: dict[str, ToolSpec] = {
...
+    ),
     ...
     # ------------------------------------------------------------------
@@ -347,6 +352,10 @@ TOOL_REGISTRY: dict[str, ToolSpec] = {
...
index e617a65..ee8a084 100644
--- a/nce/vertical_modules/netbox/circuits.py
+++ b/nce/vertical_modules/netbox/circuits.py
@@ -11,14 +11,18 @@ degradation is causally linked to circuit nodes.
...
@@ -30,21 +30,15 @@ class MockConnection:
...
@@ -74,16 +68,12 @@ class TestNetBoxCircuitEscalator:
...
@@ -137,21 +127,21 @@ class TestNetBoxCircuitEscalator:
         ]
...
+        telemetry_degradations = {"app_01": 0.90}
         ...
         escalator = NetBoxCircuitEscalator(client_mock)
         tickets = await escalator.evaluate_and_escalate(
@@ -160,3 +150,110 @@ class TestNetBoxCircuitEscalator:
