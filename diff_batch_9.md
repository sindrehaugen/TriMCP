...
@@ -311,12 +312,168 @@ async def _reembedding_tick(pool: asyncpg.Pool, mongo_client: Any) -> None:
...
@@ -423,6 +580,32 @@ async def async_main() -> None:
...
@@ -445,15 +628,21 @@ async def async_main() -> None:
