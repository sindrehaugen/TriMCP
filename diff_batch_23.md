...
@@ -112,6 +113,7 @@ EVENT_REQUIRED_PARAM_KEYS: Final[dict[str, frozenset[str]]] = {
...
diff --git a/tests/test_chain_and_decay_integration.py b/tests/test_chain_and_decay_integration.py
index dadcfa9..f0672c1 100644
--- a/tests/test_chain_and_decay_integration.py
+++ b/tests/test_chain_and_decay_integration.py
