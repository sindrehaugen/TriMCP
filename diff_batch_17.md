...
diff --git a/nce/dead_letter_queue.py b/nce/dead_letter_queue.py
index c38c2ce..f475d15 100644
--- a/nce/dead_letter_queue.py
+++ b/nce/dead_letter_queue.py
...
@@ -718,6 +752,99 @@ class NCEEngine(OrchestratorBase):
...
diff --git a/nce/outbox_relay.py b/nce/outbox_relay.py
index 9abba4d..2e6fc94 100644
--- a/nce/outbox_relay.py
+++ b/nce/outbox_relay.py
...
@@ -241,6 +264,11 @@ async def run_outbox_relay_once(
                         event["id"],
                         event["event_type"],
                     )
+                    await _dispatch_throttled_alert(
...
diff --git a/tests/test_dead_letter_queue.py b/tests/test_dead_letter_queue.py
index da9d57a..48ae717 100644
--- a/tests/test_dead_letter_queue.py
+++ b/tests/test_dead_letter_queue.py
@@ -2,7 +2,10 @@
